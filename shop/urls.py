...
urlpatterns = [
    ...
    url(r'^(?P<subcategory_slug>[-\w]+)/$', views.subcategory_list, name='product_list_by_subcategory'),
    url(r'^(?P<minicategory_slug>[-\w]+)/$', views.minicategory_list, name='product_list_by_minicategory')
